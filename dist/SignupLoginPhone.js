...
var _SignupPhone = _interopRequireDefault(require("./SignupPhone"));
...
var SignupLoginPhone = /*#__PURE__*/function (_PureComponent) {
  _inherits(SignupLoginPhone, _PureComponent);

  var _super = _createSuper(SignupLoginPhone);

  function SignupLoginPhone() {
    var _this;

    _classCallCheck(this, SignupLoginPhone);
      ...
      $.post('/' + _this.props.lang + '/' + action, data, function (r) {
        ...
        if (e.status !== 302) {
          ...
          self.setState({
            ...
            error: true,
            msg: {
              result: t('Something went wrong! Please try again later!')
            }
          });
        }
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderBlocks", function () {
      ...
      switch (s.mode) {
        ...
        case 'confirm':
          return /*#__PURE__*/_react.default.createElement(_EnterCode.default, {
            onChangeMode: _this.onChangeMode,
            ref: "resend",
            progress: s.progress,
            msg: s.msg,
  ...
  return SignupLoginPhone;
}(_react.PureComponent);

exports.default = SignupLoginPhone;